...
import { extractFrameAsBase64, verifySameScenePairs, VLM_CONFIDENCE_THRESHOLD } from './vlm-verify';
import {
  StoredCandidateSet,
  CandidateCheck,
  readCandidatesFile,
...
async function checkCandidate(
  ...
  const framePairs = pickRepresentativeFramePairs(candidate.segment);
  try {
