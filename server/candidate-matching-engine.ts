 ...
 *
 * RULES:
 *  - matching-engine.ts is the PROTECTED main engine (server.ts main match pass
 *    + vlm-segment-resolver.ts). NEVER edit it when changing candidate behavior.
 *  - All candidate-system tuning (thresholds, drift, walk params, etc.) must be
 *    done HERE, in this file only.
 *
